...
export default {
    ...
    data() {
        return {
            ...
            items: [
                {
                    title: 't_how_works__user_title_1',
                    text: 't_how_works__user_desc_1',
                    img: 'hw-phone-user__step-1.png'
                },
                {
                    title: 't_how_works__user_title_2',
                    text: 't_how_works__user_desc_2',
                    img: 'hw-phone-user__step-2.png'
                },
                {
                    title: 't_how_works__user_title_3',
                    text: 't_how_works__user_desc_3',
                    img: 'hw-phone-user__step-3.png'
                },
                {
                    title: 't_how_works__user_title_4',
                    text: 't_how_works__user_desc_4',
                    img: 'hw-phone-user__step-4.png'
                },
                {
                    title: 't_how_works__user_title_5',
                    text: 't_how_works__user_desc_5',
                    img: 'hw-phone-user__step-5.png'
                }
            ]
        };
    },
